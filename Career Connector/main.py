...
genai.configure(api_key="AIzaSyBqIcx3wsVw2d1_ZegkknmhPW92gMZFJmY")
...
if submit:
    if uploaded_file is not None:
        ...
        input_prompt=f"""
        Hey Act Like a skilled or very experience ATS(Application Tracking System), with extensive experience in evaluating resumes against job descriptions. Be a strict checker. Let's dive into the evaluation process based on the provided job description:
